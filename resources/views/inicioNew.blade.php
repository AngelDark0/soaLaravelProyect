...
<body>
    <div>
        <h2>Estudiantes API</h2>

        <div class="card">
         <div class="card-header">
         <a href="{{route('api.guardarc')}}" class="btn btn-primary">Nuevo Estudiante</a>
                    ...
                    <?php foreach($data as $est){?>
                        ...
                        <!--Esto es un comentario 
                            ...
                            @php
                               ...
                               <td>{{$direccion}}</td>
                            <td>
                                    <a href="{{route('api.editarup', [$cedula])}}" class="btn btn-warning">Editar1 Api</a>

                                     <a href="{{route('api.destroyer', [$cedula])}}" class="btn btn-danger">Eliminar Api</a>
                                </td>
                        </tr>
                        <?php } ?>
